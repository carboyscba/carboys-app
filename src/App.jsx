...
const VEHICLE_DB = {
  "Chevrolet": ["Onix", "Tracker", "Cruze", "S10", "Equinox", "Spin", "Montana", "Trailblazer"],
  "Fiat": ["Cronos", "Argo", "Pulse", "Fastback", "Strada", "Toro", "Mobi", "500e"],
  "Ford": ["Ranger", "Territory", "Bronco Sport", "Maverick", "F-150", "Ka", "EcoSport", "Focus"],
  "Honda": ["HR-V", "CR-V", "Civic", "City", "WR-V", "ZR-V", "Accord"],
  "Hyundai": ["Creta", "Tucson", "Santa Fe", "HB20", "Kona", "i30"],
  "Jeep": ["Renegade", "Compass", "Commander", "Wrangler", "Grand Cherokee", "Gladiator"],
  "Nissan": ["Kicks", "Frontier", "Sentra", "Versa", "X-Trail", "Pathfinder"],
  "Peugeot": ["208", "2008", "308", "3008", "408", "5008", "Partner"],
  "Renault": ["Sandero", "Stepway", "Logan", "Duster", "Kangoo", "Kwid", "Captur", "Koleos"],
  "Toyota": ["Hilux", "Corolla", "Corolla Cross", "Yaris", "SW4", "RAV4", "Camry", "GR86", "Land Cruiser"],
  "Volkswagen": ["Gol", "Polo", "Virtus", "T-Cross", "Taos", "Tiguan", "Amarok", "Vento", "Golf", "Saveiro"],
  "Citroën": ["C3", "C3 Aircross", "C4 Cactus", "C4 X", "C5 Aircross", "Berlingo"],
  "Mercedes-Benz": ["Clase A", "Clase C", "Clase E", "GLA", "GLB", "GLC", "GLE", "Sprinter", "Vito"],
  "BMW": ["Serie 1", "Serie 2", "Serie 3", "X1", "X2", "X3", "X5"],
  "Audi": ["A3", "A4", "A5", "Q3", "Q5", "Q7", "Q8", "e-tron"],
  "RAM": ["1500", "2500", "700"],
  "Kia": ["Seltos", "Sportage", "Sorento", "Cerato", "Carnival", "EV6"],
  "Suzuki": ["Swift", "Vitara", "Jimny", "S-Cross", "Fronx"],
  "Chery": ["Tiggo 2", "Tiggo 3", "Tiggo 4", "Tiggo 7", "Tiggo 8", "Arrizo 6"],
  "GWM": ["Haval H6", "Haval Jolion", "Ora 03"],
  "Alfa Romeo": ["Tonale", "Giulia", "Stelvio"],
  "DS": ["DS3", "DS4", "DS7"],
  "Iveco": ["Daily"],
  "Mitsubishi": ["L200", "Outlander", "ASX"],
  "Subaru": ["XV", "Forester", "Outback", "WRX"],
